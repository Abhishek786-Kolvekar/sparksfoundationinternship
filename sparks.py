...
wd = webdriver.Edge(executable_path=r"C:\Users\DELL\Downloads\msedgedriver.exe")
print(wd.title)
...
try:
    ...
    time.sleep(3)
    wd.find_element_by_name('Name').send_keys('Abhishek Kolvekar')
    time.sleep(3)
    wd.find_element_by_name('Email').send_keys('abhivk792@gmail.com')
    time.sleep(3)
